...
var typed = new Typed(".typing-text", {
    strings: ["WEB development", "Full stack development", "WEB designing", "LOGO/BANNERS editing", "Photo/Video editing"],
    loop: true,
    typeSpeed: 70,
    backSpeed: 35,
    backDelay: 1000,
...
async function fetchData(type = "skills") {
    let response
    type === "skills" ?
        response = await fetch("Abdullah.Shabbir")
        :
        response = await fetch("projects/nav")
...
srtop.reveal('.about .content .myBtn', { delay: 200 });
